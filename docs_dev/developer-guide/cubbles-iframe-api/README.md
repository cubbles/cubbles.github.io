...
2. The component's integration via the [Cubbles Tag API](../../user-guide/cubbles-tag-api/README.md) has side-effects onto the embedding page:
...
The [RTE](../../user-guide/rte/README.md) contains a html-resource:
